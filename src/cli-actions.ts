...
import type { ICentralLogRepository, IClaimedWorkItem, IJobSnapshot, IOrchestrationRepository } from "./core/contracts";
import type { ILogQueryResult, IWorkspace, WorkflowType } from "./lib/interfaces";
