...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    | `/api/v1/jobs/${SafeSlug<T>}`
    | `/api/v1/jobs/${SafeSlug<T>}/cancel`
    | `/api/v1/library/download/${SafeSlug<T>}`
    | `/api/v1/library/stream/${SafeSlug<T>}`
    | `/api/v1/library/tracks/${SafeSlug<T>}`
    | `/api/v1/library/tracks/${SafeSlug<T>}/local`
    | `/api/v1/library/tracks/${SafeSlug<T>}/play`
    | `/api/v1/users/${SafeSlug<T>}`
    | `/jobs/${SafeSlug<T>}`
